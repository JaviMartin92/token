...
const redisPub = new ioredis_1.default(REDIS_URL);
...
async function main() {
    ...
    const mintTx = await walletClient.writeContract({
        ...
        abi: MockERC20.abi,
        functionName: 'mint',
        args: [account.address, (0, viem_1.parseEther)('5000')]
    });
    ...
    const approveTx = await walletClient.writeContract({
        ...
        args: [corpAddr, (0, viem_1.parseEther)('5000')]
    });
    ...
    const injectTx = await walletClient.writeContract({
        ...
        args: [(0, viem_1.parseEther)('5000'), 'STATEMENT_Q3_AUDITED']
    });
